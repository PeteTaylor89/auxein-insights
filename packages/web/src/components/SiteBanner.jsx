// packages/web/src/components/SiteBanner.jsx
// Auxein Grow — site-wide announcement carousel.
// Mirrors the Insights SiteBanner in behaviour (auto-rotate, swipe, dismiss,
// click-to-expand) but fetches via the shared api client and targets audience='grow'.
...
const SiteBanner = () => {
  ...
  useEffect(() => {
    bannerService.getActiveBanners('grow')
