...
const footerLinks = {
  solutions: [
    ...
    { label: 'Climate Data', href: '/solutions#climate-data' },
    { label: 'Consulting', href: '/solutions#consulting' },
  ],
  company: [
    { label: 'About', href: '/about' },
    { label: 'Contact', href: '/contact' },
    { label: 'Regen Wine', href: 'https://youtube.com/@regenwine', external: true },
  ],
  legal: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-olive flex items-center justify-center">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs italic text-olive-300 -mt-1">
                  to grow
                </span>
              </div>
            </Link>
            <p className="text-charcoal-300 text-sm leading-relaxed mb-6">
              Climate intelligence and vineyard management solutions for the
              New Zealand wine industry. Data-driven insights for sustainable
              viticulture.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="https://linkedin.com/company/auxein"
                target="_blank"
              ...
              <a
                href="https://youtube.com/@regenwine"
                target="_blank"
                rel="noopener noreferrer"
                className="text-charcoal-400 hover:text-olive-300 transition-colors"
                aria-label="YouTube"
