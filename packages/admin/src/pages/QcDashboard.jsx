    ...
    >
      ...
      <section className="mb-6">
        <div className="section-header">
          ...
          <Link to="/weather" className="section-link">Station health →</Link>
        </div>
        <div className="card">
          <div className="card-body">
            <p className="text-sm text-muted">
            ...
            <table className="admin-table">
              ...
              <tbody>
                {(summary?.offenders || []).map((o) => (
                  <tr key={o.station_id}>
                    <td>
                      <Link to={`/weather/${o.station_id}`} className="table-link font-medium">
              ...
              <tbody>
                {(findings?.findings || []).map((f) => (
                  <tr key={f.id}>
                    ...
                    <td>
                      <Link to={`/weather/${f.station_id}`} className="table-link">
