                    ...
                    {confirmingId === c.id ? (
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                        {(c.status === 'draft' || c.status === 'scheduled') && (
                          <>
                            <Link to={`/email/${c.id}/edit`} style={{ color: '#2563eb' }} title="Edit"><Edit size={16} /></Link>
                            <button
                        ...
                        {c.status === 'sent' && (
                          <Link to={`/email/${c.id}/edit`} style={{ color: '#6b7280' }} title="View stats"><BarChart2 size={16} /></Link>
                        )}
                      </div>
                    )}
                  </td>
