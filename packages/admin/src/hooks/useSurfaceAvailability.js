...
//   packages/insights/src/hooks/useSurfaceAvailability.js
//
...
// Insights' PublicAuthContext does not exist on this origin — the admin app
// carries both identities in AdminAuthContext. Only the Insights half matters
// here, because surface availability is gated by the Insights entitlement.
...
export default function useSurfaceAvailability(
  ...
  const { insightsUser: user, isAuthenticated } = useAdminAuth();
