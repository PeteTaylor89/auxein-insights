...
Station_Network_file = 'Z:\\Data\\VCDN_500m_Regional\\VCDN_500m_Marlborough.csv'
lapse_rate = 0.6
...
stats_loc = os.path.join(log_path, f'{climate_variable}_Cross_Validation_Summary_{today_date}.csv')
